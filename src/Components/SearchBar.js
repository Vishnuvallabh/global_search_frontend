...
//       // Add the current query to the history if it's not already there
...
//         localStorage.setItem('queryHistory', JSON.stringify(updatedQueryHistory)); // Store in localStorage
//       }
//     } catch (error) {
//       console.error('Error fetching search results:', error);
//       setSearchResults([]); // Reset results if there is an error
